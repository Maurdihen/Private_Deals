...
class FathersView(Resource):
    ...
    def get(self):
        ...
        """
        return fathers_schema.dump(father_serv.get_all()), 200
...
class FatherView(Resource):
    ...
    def get(self, fid):
        ...
        """
        return father_schema.dump(father_serv.get_one(fid)), 200
    ...
    def patch(self, fid):
        ...
        father_serv.update_partial(data, fid)
        return "", 204
    ...
    def delete(self, fid):
        ...
        """
        return father_serv.delete(fid), 204